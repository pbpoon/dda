...
urlpatterns = [
    ...
    path('inventory_order/item/<pk>/set_check/', views.InventoryOrderItemSetCheckView.as_view(),
    ...
    path('move_order/item/<pk>/edit/', views.MoveLocationOrderItemEditView.as_view(),
         name='move_location_order_item_edit'),
    path('move_order/item/<pk>/delete/', views.MoveLocationOrderItemDeleteView.as_view(),
         name='move_location_order_item_delete'),
    path('move_order/<pk>/update/', views.MoveLocationOrderUpdateView.as_view(), name='move_location_order_update'),
