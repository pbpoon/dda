...
#     long = models.PositiveSmallIntegerField(verbose_name=u'长', help_text='单位cm')
#     height = models.PositiveSmallIntegerField(verbose_name=u'高', help_text='单位cm')
...
# #     sn = models.ForeignKey('SN', null=False)
