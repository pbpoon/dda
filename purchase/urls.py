...
urlpatterns = [
    ...
    path('order/item/edit/<pl>/', views.PurchaseOrderItemEditView.as_view(), name='purchase_order_item_edit'),
    path('order/item/create/', views.PurchaseOrderItemEditView.as_view(), name='purchase_order_item_create'),
